...
def upload_raw_data_to_hdfs(local_dir, hdfs_dir):
    """
    로컬 디렉토리의 raw CSV 파일을 HDFS에 업로드. 이미 존재하는 경우 덮어씁니다.
    """
    # HDFS 디렉토리가 없으면 생성
...
if __name__ == "__main__":
    ...
    local_directory = "../data/raw"  # 현재 디렉토리 기준 상대 경로
    hdfs_directory = "/user/maria_dev/term_project_data/raw"  # HDFS 내 업로드 경로
